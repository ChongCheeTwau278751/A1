...
public class Restaurant {//1.3 User define class
	...
	Restaurant(String name, String opr, String loc, String mn, String food, String bvrg, String dsrt, String hp){
		this.name = name;
		this.operation = opr;
		this.location = loc;
		this.menu = mn;
	...
	public String restaurants() {//1.4 Constructor with no argument
	...
	public String restaurants(String f) {//1.4 Constructor with one argument
    	return "\nXymaxx Restaurant only serves Malaysian traditional dishes and foods such as " + f + " which is wellknown all around the world!";
    }
    
    public String restaurants(String b, String d) {//1.4 Constructor with two argument
